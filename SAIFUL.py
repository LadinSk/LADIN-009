#THE TOOL CREATED BY LADIN SK
#India Cyber Security Force 
#FB : https://www.facebook.com/NAHID.T6RA.PAPA.OLD.KING?mibextid=ZbWKwL
#PAGE : Md. Saiful Islam
#Programer Md. Saiful Islam
#𝐖𝐇𝐀𝐓'𝐒 𝐀𝐏𝐏 : +0566020917
W = '\033[97;1m' 
R = '\033[91;1m' 
G = '\033[92;1m' 
Y = '\033[93;1m' 
...
║\33[1;32m[↦] 𝙶𝙸𝚃𝙷𝚄𝙱     : LADIN SK
║\33[1;32m[↦] 𝚆𝚑𝚊𝚝𝚜𝚊𝚙𝚙   : +0566020917
...
class Main:
	def __init__(self):
		...
		if syed in ["", " "]:
			...
			os.system('xdg-open https://www.facebook.com/https://www.facebook.com/NAHID.T6RA.PAPA.OLD.KING?mibextid=ZbWKwL/')
			print("")
			time.sleep(2.0)
			...
			print("\033[1;32m  The Tool Created By LADIN SK ")
			time.sleep(2.0)
			os.system("clear")
		print(logo)
		print("\033[0;90m╔══════════════════════════════════════════════════════════╗")
		...
		if DEVIL in ["1", "01"]:
			self.fbtua()
		if DEVIL in ["2", "02"]:
			os.system('xdg-open https://github.com/LadinSk')
		if DEVIL in ["3", "03"]:
